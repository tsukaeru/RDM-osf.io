...
urlpatterns = [
    ...
    url(r'^authentication/$', views.InstitutionListView.as_view(), name='institutions'),
    url(r'^(?P<institution_id>-?[0-9]+)/authentication/$', views.UserAuthenticationControlView.as_view(), name='authentication'),
