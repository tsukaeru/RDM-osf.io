                ...
                % if addon_name == 'integromat':
                    <div id="integromat-content" class="scripted">
                        ...
                        <table class='table'>
                            ...
                            <tr><td data-bind="text: fields.subject"></td><td data-bind="date: fields.start_datetime, dateFormat: 'YYYY-MM-DD HH:mm'"></td><td><button class='fa fa-play' data-bind="click: startMeeting.bind($data, fields.join_url)"></button></td></tr>
                            </tbody>
                        </table>
                        <!-- /ko -->
                    </div>
