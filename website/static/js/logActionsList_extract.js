...
var rushfiles_file_added = _('${user} added file ${rushfiles_path} to RushFiles in ${node}');
var rushfiles_file_removed = _('${user} removed ${path_type} ${rushfiles_path} from RushFiles in ${node}');
var rushfiles_file_updated = _('${user} updated file ${rushfiles_path} in RushFiles in ${node}');
var rushfiles_folder_created = _('${user} created folder ${rushfiles_path} in RushFiles in ${node}');
var rushfiles_folder_selected = _('${user} linked RushFiles folder ${rushfiles_folder} to ${node}');
var rushfiles_node_authorized = _('${user} authorized the RushFiles addon for ${node}');
var rushfiles_node_deauthorized = _('${user} deauthorized the RushFiles addon for ${node}');
var rushfiles_node_deauthorized_no_user = _('RushFiles addon for ${node} deauthorized');
