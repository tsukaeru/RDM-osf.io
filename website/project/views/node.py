...
from addons.integromat.utils import serialize_integromat_widget
...
def view_project(auth, node, **kwargs):
    ...
    if 'integromat' in ret['addons']:
        addons_widget_data['integromat'] = serialize_integromat_widget(node)
