...
class AllMeetingInformation(BaseModel):
    ...
    attendees = models.ManyToManyField(Attendees, relate_name='attendees_meetings')
    attendees_specific = models.ManyToManyField(Attendees, relate_name='attendees_specific_meetings', through='AllMeetingInformationAttendeesRelation')
