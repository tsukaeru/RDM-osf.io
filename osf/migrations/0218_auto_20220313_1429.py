...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=('osf.rushfilesfilenode', models.Model),
        ),
        migrations.CreateModel(
            name='RushFilesFolder',
            fields=[
            ],
            options={
                'proxy': True,
